...
public class InterfaceUsuario {
	...
	public static void cadastrarAluno() {
		...
		if (!Fachada.getInstance().consultarAluno(cpf)) {
			...
			int cep = Integer.parseInt(JOptionPane.showInputDialog("Digite o CEP: ").toString());
	...
	public static void verAlunos() {
		...
		do {
			...
			if (Fachada.getInstance().consultarProfessor(cpfP) && Fachada.getInstance().consultarTurma(codT) && turnoValido && Fachada.getInstance().consultarCurso(codC))
	...
	public static void consultarTurmas() {
		...
		List<String> turmas = Fachada.getInstance().consultarTurmas();
